    ...
    return (
        ...
        <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
            ...
            <div className="space-y-4">
                ...
                <details className="w-full border rounded-lg">
                    <summary className="px-4 py-6 focus:outline-none focus-visible:ring-blue-400">Eleifend feugiat sollicitudin laoreet adipiscing bibendum suscipit erat?</summary>
